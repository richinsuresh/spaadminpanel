...
export default function AttendancePage() {
  ...
  const filteredEmployees = employees.filter(emp => 
    selectedOutlet === 'all' || emp.outlet === selectedOutlet
  );
  ...
  const getStats = () => {
    ...
    return { presentCount, absentCount, leaveCount, total: filteredEmployees.length };
  };
    ...
    <div className="space-y-6">
              ...
              {filteredEmployees.length === 0 ? (
                <tr>
                  <td colSpan={4} className="px-6 py-4 text-center text-gray-500">
                    No employees found for the selected outlet
                  </td>
                </tr>
              ) : (
      ...
      <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
        <p className="text-blue-700">
          💡 Note: Attendance is saved to your browser's local storage. In production, this will be saved to your database.
        </p>
      </div>
    </div>
  );
